...
interface SignUpFormProps {
  onSubmit: (data: Omit<SignUpFormData, 'confirmPassword' | 'acceptTerms'>) => Promise<void>;
  isLoading?: boolean;
}
        ...
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-6">
          ...
          <div>
            ...
            >
              ...
              <option value="restaurant">Restaurant Owner - Manage your restaurant</option>
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="btn-primary w-full btn-md flex items-center justify-center"
          >
            {isLoading ? (
              <>
